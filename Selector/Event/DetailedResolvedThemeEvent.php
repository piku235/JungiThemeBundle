...
class DetailedResolvedThemeEvent extends ResolvedThemeEvent
{
     ...
     */
    public function __construct($resolverType, ThemeInterface $theme, ThemeResolverInterface $resolver, Request $request, $clearTheme = true)
    {
        ...
        // Parent
        parent::__construct($theme, $resolver, $request, $clearTheme);
    }
