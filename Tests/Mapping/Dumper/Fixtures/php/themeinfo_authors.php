...
$collection->add(new \Jungi\Bundle\ThemeBundle\Core\Theme(
    ...
    \Jungi\Bundle\ThemeBundle\Core\Information\ThemeInfoEssence::createBuilder()
        ->setName('FooTheme')
        ->addAuthor(new \Jungi\Bundle\ThemeBundle\Core\Information\Author('piku235', 'piku235@gmail.com'))
        ->addAuthor(new \Jungi\Bundle\ThemeBundle\Core\Information\Author('piku234', 'jungi@gmail.com', 'foo.com'))
        ->getThemeInfo(),
